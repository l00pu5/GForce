...
.equ TIM2, 0x40000000
.equ OFS_TIM2_CR1, 0x00
.equ OFS_TIM2_CR2, 0x04
.equ OFS_TIM2_CCMR1, 0x18
.equ OFS_TIM2_CCMR2, 0x1c
.equ OFS_TIM2_CCER, 0x20
.equ OFS_TIM2_PSC, 0x28
.equ OFS_TIM2_ARR, 0x2c
.equ OFS_TIM2_CCR1, 0x34
.equ OFS_TIM2_CCR2, 0x38
.equ OFS_TIM2_CCR3, 0x3c
.equ OFS_TIM2_CCR4, 0x40
...
init_TIM2:
 ...
 ldr r0, =TIM2
 ldr r1, =OFS_TIM2_CCMR2
 ldr r2, =0x68
 str r2, [r0, r1]
 @@@       -> enable capture/compare channels
 ldr r0, =TIM2
 ldr r1, =OFS_TIM2_CCER
 ldr r2, =0x100
 str r2, [r0, r1]
 @@@       -> set up TIMx_ARR
 ldr r0, =TIM2
